...
* Todos os parâmetros dentro dos limites estabelecidos: lançamento autorizado;
* Pelo menos um parâmetro fora dos limites estabelecidos: lançamento abortado.
...
INÍCIO
    ...
    SE sistema_ok == VERDADEIRO ENTÃO
        ...
        EXIBIR "===================================="
        EXIBIR "     STATUS: LANÇAMENTO AUTORIZADO"
        EXIBIR "===================================="

    SENÃO

        EXIBIR "===================================="
        EXIBIR "    STATUS: LANÇAMENTO NÃO AUTORIZADO"
        EXIBIR "===================================="
...
flowchart TD
    ...
    K -- Não --> L[Definir status:<br/>LANÇAMENTO AUTORIZADO]
    K -- Sim --> M[Definir status:<br/>LANÇAMENTO NÃO AUTORIZADO]
